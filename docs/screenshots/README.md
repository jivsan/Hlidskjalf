...
```
  ...
  ║   RACK: 47  |  SUBLEVEL: TOKYO NIGHT  |  v0.3.2-alpha    ║
  ╚══════════════════════════════════════════════════════════╝
```
...
|-------------|------------|------------------------------------------|--------|
| **v0.3.2-alpha** | CURRENT    | **Multi-user VPS model**: Admin panel (fleet, provision, Users mgmt, full switch) + regular User panel (exactly one VM: power/graphs/bandwidth/console + switch activity view). Scoped APIs, auto-bootstrap, out-of-box remote deploy. | [ENTER →](v0.3.2-alpha/README.md) |
